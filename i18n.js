...
const STR = {
  en: {
    ...
    heroLead:'Two steps between you and the volume standing in the warehouse. Tell us the line you buy and the thickness you need — the warehouse answers on the last screen. Skip both and see everything available right now.',
    ...
    s1title1:'Which line', s1title2:'are you buying?',
    ...
    s2body:'Pick the thickness you buy and, if it matters, the log mix behind the face. More eucalyptus means higher density; more pine means a lighter panel. Leave a row untouched to keep it open.',
  ...
  es: {
    ...
    heroLead:'Dos pasos entre usted y el volumen que hay en el almacén. Diga la línea que compra y el espesor que necesita — el almacén responde en la última pantalla. Omita ambos y vea todo lo disponible ahora.',
    ...
    s1title1:'¿Qué línea', s1title2:'está comprando?',
    ...
    s2body:'Elija el espesor que compra y, si importa, la mezcla de troncos detrás de la cara. Más eucalipto significa mayor densidad; más pino, un panel más liviano. Deje una fila sin tocar para mantenerla abierta.',
  ...
  pt: {
    ...
    heroLead:'Duas etapas entre você e o volume que está no armazém. Diga a linha que você compra e a espessura que precisa — o armazém responde na última tela. Pule as duas e veja tudo o que está disponível agora.',
    ...
    s1title1:'Qual linha', s1title2:'você está comprando?',
    ...
    s2body:'Escolha a espessura que você compra e, se fizer diferença, a mistura de toras atrás da face. Mais eucalipto significa maior densidade; mais pinus, painel mais leve. Deixe uma fileira sem tocar para mantê-la aberta.',
